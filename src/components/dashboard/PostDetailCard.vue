<template>
  <div class="max-w-4xl mx-auto bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100/80 transition-all duration-300">
    ...
    <div class="relative h-64 md:h-[400px] overflow-hidden bg-gray-50">
      ...
      >
        <span
          ...
          :class="{ 'fill-icon text-red-500': isFavoriteState }"
        >
          favorite
        </span>
      </button>
    ...
    <div class="p-6 md:p-10">
      ...
      <div class="flex items-center gap-3 mb-8 p-4 rounded-xl bg-gray-50/50 border border-gray-100/60">
        <div class="w-10 h-10 rounded-full overflow-hidden border-2 border-white bg-gray-100 flex items-center justify-center shrink-0 shadow-sm">
          <img
      ...
      <!-- Main Content Block -->
      <article class="prose prose-blue max-w-none text-gray-700 leading-relaxed text-sm md:text-base whitespace-pre-line mb-8">
        {{ post.content }}
      </article>
